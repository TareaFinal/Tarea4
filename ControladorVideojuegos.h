...
class ControladorVideojuegos : public iControladorVideojuegos {
	...
	public:
                ...
                float calcularEstadistica(int estadistica, string nombreVideojuego); //no deberia de ser de la misma clase que el identificador de estadisticas que viene a ser un int? ---- Ag: Si, lo deje porque asi estaba
